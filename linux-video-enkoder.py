...
class VideoConverterWindow(Gtk.Window):
    def __init__(self):
        ...
        # --- Format Auswahl (MP4 / MKV) ---
        grid.attach(Gtk.Label(label="Format:", xalign=0), 0, 0, 1, 1)
    ...
    def build_ffmpeg_args(self, infile, outfile):
        ...
        if audio_copy:
            ...
            # WICHTIG: Erzwinge korrekte Sampling-Parameter für PCM und DaVinci Resolve
            if achoice == "PCM":
                args += ["-ar", "48000"]
